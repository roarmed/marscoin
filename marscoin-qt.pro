...
# libqrencode (https://fukuchi.org/works/qrencode/index.html.en) must be installed for support
...
contains(MARSCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += MARSCOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/marscoingui.h \
    ...
    src/qt/marscoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/marscoin.cpp \
    ...
    src/qt/marscoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/marscoinstrings.cpp \
    src/qt/marscoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
win32:FORMS += src/qt/forms/sendcoinsdialog.ui \
    src/qt/forms/coincontroldialog.ui \
    src/qt/forms/addressbookpage.ui \
    src/qt/forms/chatwindow.ui \
    src/qt/forms/signverifymessagedialog.ui \
    ...
    src/qt/forms/editaddressdialog.ui \
    src/qt/forms/transactiondescdialog.ui \
    src/qt/forms/win/overviewpage.ui \
    src/qt/forms/sendcoinsentry.ui \
    src/qt/forms/askpassphrasedialog.ui \
    src/qt/forms/rpcconsole.ui \
    src/qt/forms/optionsdialog.ui \
...
contains(MARSCOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = marscoin-qt_test
DEFINES += MARSCOIN_QT_TEST
...
# also add new translations to src/qt/marscoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/marscoin_*.ts)
...
win32:RC_FILE = src/qt/res/marscoin-qt.rc
